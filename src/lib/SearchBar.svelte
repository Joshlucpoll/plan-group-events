...
<div class="input-wrapper">
  ...
  <h2 bind:this={subtitle} class="subtitle">
    ...
    <Tooltip
      title="a word blend in created for each event, it's made of 3 words. if you made an event check your email for the word blend, or ask the organiser if you didn't"
    >
      <img
        id="help-icon"
